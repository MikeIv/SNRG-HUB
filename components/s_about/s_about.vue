...
export default {
  ...
  methods: {
    runSwiper() {
      if (this.show) {
        this.$refs.swiperUniversities[0].$swiper.autoplay.start();
        this.$refs.swiperUniversities[1].$swiper.autoplay.start();
      } else {
        this.$refs.swiperStudents[0].$swiper.autoplay.start();
        this.$refs.swiperStudents[1].$swiper.autoplay.start();
      }
    },
    handleResize() {
